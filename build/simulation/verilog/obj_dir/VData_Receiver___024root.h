...
#ifndef VERILATED_VDATA_RECEIVER___024ROOT_H_
#define VERILATED_VDATA_RECEIVER___024ROOT_H_  // guard

#include "verilated.h"

class VData_Receiver__Syms;

class VData_Receiver___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    VData_Receiver___024root(VData_Receiver__Syms* symsp, const char* v__name);
    ~VData_Receiver___024root();
    VL_UNCOPYABLE(VData_Receiver___024root);
