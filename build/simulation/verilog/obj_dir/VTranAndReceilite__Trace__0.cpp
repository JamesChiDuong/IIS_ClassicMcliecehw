...
void VTranAndReceilite___024root__trace_chg_sub_0(VTranAndReceilite___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VTranAndReceilite___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTranAndReceilite___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VTranAndReceilite___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VTranAndReceilite___024root__trace_chg_sub_0(VTranAndReceilite___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VTranAndReceilite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTranAndReceilite___024root__trace_chg_sub_0\n"); );
    // Init
...
void VTranAndReceilite___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTranAndReceilite___024root__trace_cleanup\n"); );
    // Init
    VTranAndReceilite___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VTranAndReceilite___024root*>(voidSelf);
    VTranAndReceilite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
