...
VL_ATTR_COLD void VData_Receiverlite___024root__trace_init_sub__TOP__0(VData_Receiverlite___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VData_Receiverlite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiverlite___024root__trace_init_sub__TOP__0\n"); );
    // Init
...
VL_ATTR_COLD void VData_Receiverlite___024root__trace_init_top(VData_Receiverlite___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VData_Receiverlite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiverlite___024root__trace_init_top\n"); );
    // Body
    VData_Receiverlite___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void VData_Receiverlite___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp);
...
VL_ATTR_COLD void VData_Receiverlite___024root__trace_register(VData_Receiverlite___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VData_Receiverlite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiverlite___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&VData_Receiverlite___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&VData_Receiverlite___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&VData_Receiverlite___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VData_Receiverlite___024root__trace_full_sub_0(VData_Receiverlite___024root* vlSelf, VerilatedVcd::Buffer* bufp);

VL_ATTR_COLD void VData_Receiverlite___024root__trace_full_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiverlite___024root__trace_full_top_0\n"); );
    // Init
    VData_Receiverlite___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VData_Receiverlite___024root*>(voidSelf);
    VData_Receiverlite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VData_Receiverlite___024root__trace_full_sub_0((&vlSymsp->TOP), bufp);
}

VL_ATTR_COLD void VData_Receiverlite___024root__trace_full_sub_0(VData_Receiverlite___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VData_Receiverlite__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiverlite___024root__trace_full_sub_0\n"); );
    // Init
