...
void VData_Receiver___024root__trace_chg_sub_0(VData_Receiver___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VData_Receiver___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiver___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VData_Receiver___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VData_Receiver___024root__trace_chg_sub_0(VData_Receiver___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VData_Receiver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiver___024root__trace_chg_sub_0\n"); );
    // Init
...
void VData_Receiver___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VData_Receiver___024root__trace_cleanup\n"); );
    // Init
    VData_Receiver___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VData_Receiver___024root*>(voidSelf);
    VData_Receiver__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
