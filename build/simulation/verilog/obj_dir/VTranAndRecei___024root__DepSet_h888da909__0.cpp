...
VL_INLINE_OPT void VTranAndRecei___024root___nba_sequent__TOP__2(VTranAndRecei___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTranAndRecei__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTranAndRecei___024root___nba_sequent__TOP__2\n"); );
    // Body
...
void VTranAndRecei___024root___eval_nba(VTranAndRecei___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VTranAndRecei___024root___nba_sequent__TOP__2(vlSelf);
    }
