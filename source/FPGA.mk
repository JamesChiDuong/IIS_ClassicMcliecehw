...
PAR_FILE := $(ROOT_PATH)/FPGA/parameters.mk
include $(PAR_FILE)

# Include toolset
TOOLS_FILE := $(ROOT_PATH)/FPGA/tools.mk
NO_CHECK := TRUE
include $(TOOLS_FILE)
undefine NO_CHECK

NO_SUB_INCLUDES = True
#include $(ROOT_PATH)/modules/common/systemizer/modules.mk

XILINX_MODELS_FILE := $(ROOT_PATH)/FPGA/Xilinx/models.mk
