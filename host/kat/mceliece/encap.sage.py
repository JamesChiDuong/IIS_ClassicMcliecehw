...
# This file was *autogenerated* from the file encap.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8)
from . import encode
...
def encap_abstract(T,randombits,params):
  ...
  if parameters.supportpc:
    ...
    if params.pc:
      ...
      C1 = H((_sage_const_2 ,e))
      C = C0,C1
      K = H((_sage_const_1 ,e,C))
      return C,K,e
...
def test1():
  ...
  for system in parameters.alltests:
    ...
    if parameters.supportpc and P.pc:
      # for testing against previous versions
      assert len(C) == ceil(m*t/_sage_const_8 )+ceil(l/_sage_const_8 )
    else:
      assert len(C) == ceil(m*t/_sage_const_8 )
    assert len(K) == ceil(l/_sage_const_8 )
