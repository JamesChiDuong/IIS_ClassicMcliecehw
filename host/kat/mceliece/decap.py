...
# This file was *autogenerated* from the file decap.sage
...
def decap_abstract(C,priv,params):
  ...
  if parameters.supportpc:
    ...
    if params.pc:
      ...
      if e == False: return H((_sage_const_0 ,s,C))
      C1prime = H((_sage_const_2 ,e))
      if C1prime != C1: return H((_sage_const_0 ,s,C))
      return H((_sage_const_1 ,e,C))
