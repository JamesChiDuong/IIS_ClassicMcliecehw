...
DECAPSULATION_SUBMODULES := DECRYPTION SHAKE256 MEMORY_SINGLE MEMORY_DUAL FIELD_ORDERING
...
COMMON_SRC_PATH ?= $(DECAPSULATION_SRC_PATH)/../common
# Source path for the KAT generation script
KATGEN_SRC_PATH ?= $(DECAPSULATION_SRC_PATH)/../../host/kat
