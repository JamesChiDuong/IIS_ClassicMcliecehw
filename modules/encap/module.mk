...
KATGEN_SRC_PATH ?= $(ENCAPSULATION_SRC_PATH)/../../host/kat
...
include $(ENCAPSULATION_SRC_PATH)/../../platform/rtl/rtl.mk
...
ENCAPSULATION_TB_SRC = encap_tb.v
...
ENCAPSULATION_VERILATOR_TB_SRC = $(ENCAPSULATION_SRC_PATH)/../../platform/cpp/encap_tb.cpp
...
# Simulation binaries
ENCAPSULATION_VERILATOR_BIN_$(1)_$(2) = $$(BUILD_DIR_TB_$(1))/encap_tb_$(2).bin
...
$$(ENCAPSULATION_RESULT_TB_$(1)_$(2)): $$(ENCAPSULATION_VERILATOR_BIN_$(1)_$(2))
	$$<
	$(SAGE) $(MCELIECE_KATGEN) \
	--check-encaps \
	--kat-path $$(KAT_DIR_$(1)) \
	--pars $(1) \
	--sessionkey $$(BUILD_DIR_TB_$(1))/K_$(2).out \
	--cipher $$(BUILD_DIR_TB_$(1))/cipher_0_$(2).out $$(BUILD_DIR_TB_$(1))/cipher_1_$(2).out \
...
$$(ENCAPSULATION_RESULT_SYNTH_CLOCKS_$(1)_$(2)_$(3)): $$(ENCAPSULATION_$(2)) $$(XILINX_RESOURCE_ANALYSIS_TCL) $$(XILINX_CONSTRAINTS_TIMING_$(1)) | $$(RESULTS_DIR)
	$$(VIVADO) \
	-nojournal \
