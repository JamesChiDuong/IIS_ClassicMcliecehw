...
VFLAGS 		:= -Wall --MMD --trace --unroll-count 1024 --Wno-fatal -Wno-BLKANDNBLK --timescale-override 1ps/1ps -y $(RTLDR) --top-module $(MODULES) \-GKEY_START_ADDR=0 \$(FILE_VCD) \$(FILE_CYCLES_PROFILE) \$(FILE_K_OUT) \$(FILE_CIPHER0_OUT) \$(FILE_CIPHER1_OUT) \$(FILE_ERROR_OUT) \$(FILE_MEM_SEED) \$(FILE_PK_SLICED) --cc \clog2.v
