...
XILINX_RESOURCE_PROGRAM_TCL  = $(XILINX_DEVICES_PATH)/resource_program.tcl
...
XILINX_CONSTRAINTS_PIN_$(1) = $(XILINX_DEVICES_PATH)/pin_$(1).xdc

XILINX_TARGETS += $$(XILINX_CONSTRAINTS_TIMING_$(1))

XILINX_TARGETS += $$(XILINX_CONSTRAINTS_PIN_$(1))
